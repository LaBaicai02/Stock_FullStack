...
class StockDataCollector:
    ...
    nasdaq_company_list_file = './my_package/tmp/nasdaq_100.csv'
    COMPANY_OVERVIEW_FILE = './my_package/tmp/company_overview.csv'
    STOCK_WEEKLY_DATA_FILE = './my_package/tmp/stock_weekly_data.csv'
    QUARTERLY_EARNINGS_FILE = './my_package/tmp/quarterly_earnings.csv'
    CASH_FLOW_FILE = './my_package/tmp/cash_flow.csv'
    NEWS_SENTIMENT_FILE = './my_package/tmp/news_sentiment.csv'
